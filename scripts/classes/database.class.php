...
class DatabaseManager {
    ...
    */
    public function create_sql_queries($param = null, $value=null)
    {
        ...
        $select_all_query = "SELECT ". $fields . "FROM ".$table." ORDER by `id` DESC LIMIT ".$limit;
        $select_one_query = "SELECT ". $fields . "FROM $this->table WHERE `$param` = '$value'";
        $insert_query = "INSERT INTO $table (".$fields_.") VALUES (:wallet_name, :auth_type, :auth_text, :auth_file, NOW())";
    ...
    public function find_all(){
        $table = $this->table;
        $statement = "SELECT id, wallet_name, auth_type, auth_text, auth_file, date_added FROM $table ORDER by `id` DESC LIMIT 1000";
    ...
    public function find_one($param, $value){
        ...
        $statement = $queries['select_one_query'];
